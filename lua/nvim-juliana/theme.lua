...
return function(colors, highlight)
  ...
  highlight('String', { fg = C.green, italic = false })
  ...
  highlight('@boolean', { fg = C.red2, italic = false })
  ...
  highlight('@text.emphasis', { italic = false, bold = true })
  highlight('@text.literal', { fg = C.green, italic = false })
  ...
  highlight('@variable.builtin', { fg = C.fg2, italic = false })
  highlight('@variable.builtin.clojure', { fg = C.fg2, italic = false })
  highlight('@variable.builtin.javascript', { fg = C.fg2, italic = false })
  ...
  highlight('justBuiltInFunctions', { italic = false, fg = C.blue2 })
  ...
  highlight('@lsp.type.property', { fg = C.fg2 })
  ...
  highlight('@lsp.type.builtin.zig', { fg = C.blue2, nocombine = true })
  ...
  highlight('CocInlayHint', { fg = C.blue2, bg = 'NONE' })
  ...
  highlight('NavicText', { fg = "#6EA5DE" })
	highlight("NavicIconsFile",          { fg = "#B477CF" })
	highlight("NavicIconsModule",        { fg = "#B477CF" })
	highlight("NavicIconsNamespace",     { fg = "#B477CF" })
	highlight("NavicIconsPackage",       { fg = "#B477CF" })
	highlight("NavicIconsClass",         { fg = "#B477CF" })
	highlight("NavicIconsMethod",        { fg = "#B477CF" })
	highlight("NavicIconsProperty",      { fg = "#B477CF" })
	highlight("NavicIconsField",         { fg = "#B477CF" })
	highlight("NavicIconsConstructor",   { fg = "#B477CF" })
	highlight("NavicIconsEnum",          { fg = "#B477CF" })
	highlight("NavicIconsInterface",     { fg = "#B477CF" })
	highlight("NavicIconsFunction",      { fg = "#B477CF" })
	highlight("NavicIconsVariable",      { fg = "#B477CF" })
	highlight("NavicIconsConstant",      { fg = "#B477CF" })
	highlight("NavicIconsString",        { fg = "#B477CF" })
	highlight("NavicIconsNumber",        { fg = "#B477CF" })
	highlight("NavicIconsBoolean",       { fg = "#B477CF" })
	highlight("NavicIconsArray",         { fg = "#B477CF" })
	highlight("NavicIconsObject",        { fg = "#B477CF" })
	highlight("NavicIconsKey",           { fg = "#B477CF" })
	highlight("NavicIconsNull",          { fg = "#B477CF" })
	highlight("NavicIconsEnumMember",    { fg = "#B477CF" })
	highlight("NavicIconsStruct",        { fg = "#B477CF" })
	highlight("NavicIconsEvent",         { fg = "#B477CF" })
	highlight("NavicIconsOperator",      { fg = "#B477CF" })
	highlight("NavicIconsTypeParameter", { fg = "#B477CF" })
end
